...
export default function Header() {
  return (
    <>
          <header className="my-10 lg:my-14 mb-8 lg:mb-10 mx-auto max-w-7xl">
        <div
        ...
        >
          ...
          <div>
            ...
            >
              Arif Trending Books of the Year
            </h2>
          ...
          <div className="flex items-stretch space-x-3">
            ...
            <select
              className="cursor-pointer rounded-md border border-gray-400 ring-2 px-4 py-2 text-center text-gray-600"
              name="sortBy"
              id="sortBy"
            >
