...
export default function Navebar() {
  ...
  <div className='flex gap-2'>
       <a href="/">
          <img
            className="max-w-[60px] md:max-w-[75px] rounded-3xl hover:rounded-2xl ring-2 hover:opacity80 hover:ring-4"
            src={Pik}
            alt="Lws"
          />
        </a>
        <p className="text-red-500 items-center text-center font-bold hover:text-green-600 text-[20px]"> <span className="text-[13px] font-medium">my name</span> <br /> Arif <span className="text-[15px] font-medium">Hasan</span> </p>
